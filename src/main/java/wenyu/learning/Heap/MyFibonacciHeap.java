 ...
 * the min pointer to be the smaller of the minima of the two heaps.  
 * 
 * Peeking at the smallest element can therefore be accomplished by just looking at
 ...
 * @author Keith Schwarz (htiek@cs.stanford.edu)
 */
public final class MyFibonacciHeap<T> {
     ...
     *         heaps.
     */
    public static <T> MyFibonacciHeap<T> merge(MyFibonacciHeap<T> one, MyFibonacciHeap<T> two) {
        /* Create a new FibonacciHeap to hold the result. */
    	MyFibonacciHeap<T> result = new MyFibonacciHeap<T>();
    ...
    public static void main(String[] args) {
    	MyFibonacciHeap<Integer> heap = new MyFibonacciHeap<Integer>();
    	heap.enqueue(1, 0);
    	heap.enqueue(2, 1);
    	heap.enqueue(3, 2);
    	heap.enqueue(5, 3);
    	...
    	System.out.println("heap.dequeueMin: " + heap.dequeueMin().mElem);
    	System.out.println("heap.dequeueMin: " + heap.dequeueMin().mElem);
    	System.out.println("heap.dequeueMin: " + heap.dequeueMin().mElem);
    	System.out.println("heap.dequeueMin: " + heap.dequeueMin().mElem);
    	System.out.println("heap.dequeueMin: " + heap.dequeueMin().mElem);
