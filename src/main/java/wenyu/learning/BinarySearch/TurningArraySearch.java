...
public class TurningArraySearch extends ParentClassBenchMark {
	...
	public static void main(String[] args) throws Exception {
		...
		demoEntry(new TurningArraySearch(), runtime, TurningArraySearch.class.getMethod("binarySearch", int[].class), array);
		demoEntry(new TurningArraySearch(), runtime, TurningArraySearch.class.getMethod("sequentialSearch", int[].class), array);
	}
