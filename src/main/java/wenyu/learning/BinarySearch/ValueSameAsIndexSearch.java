...
public class ValueSameAsIndexSearch extends ParentClassBenchMark {
	...
	public static void main(String[] args) throws Exception {
		...
		while(count-- > 0) {
			...
			demoEntry(new ValueSameAsIndexSearch(), runtime, ValueSameAsIndexSearch.class.getMethod("SEQIndexEqualSearch", int[].class), array);
			demoEntry(new ValueSameAsIndexSearch(), runtime, ValueSameAsIndexSearch.class.getMethod("BSIndexEqualSearch", int[].class), array);
			System.out.println();
		}
	}
}
